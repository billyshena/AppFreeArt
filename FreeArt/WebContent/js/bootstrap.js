...
$('body').prepend('<div id="panel"><div class="navbar navbar-inverse navbar-fixed-top" id="advanced"><span class="trigger"><strong></strong><em></em></span><div class="navbar-inner"><div class="container"><button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-top-collapse"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="brand" href="/FreeArt/">Free Art Home</a><div class="nav-collapse collapse nav-top-collapse"><ul class="nav"><li class="home"><a href="/FreeArt/"><img src="img/tm/tm_home.png"></a></li><li class="divider-vertical"></li><li class=""><a href="/FreeArt/login">Se connecter</a></li><li class=""><a href="/FreeArt/catalogue">Nos catalogues</a></li><li><a href="/FreeArt/oeuvre">Oeuvres</a></li></li></ul></div></div></div></div></div>');
}); 
